...
export const replaceUserIdInCategories = async (req, res) => {
    try {
      const Categories =  await database.listDocuments(DATABASE_ID, COLLECTION_ID,[
        Query.limit(100),
      ...
      let i=0;
      Categories.documents.forEach(async (poste)=>{
