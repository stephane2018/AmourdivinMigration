...
export const replaceUserIdInPostes = async (req, res) => {
    try {
      const postes =  await database.listDocuments(DATABASE_ID, COLLECTION_ID,[
        Query.limit(100),
      ...
      let i=0;
      postes.documents.forEach(async (poste)=>{
  ...
  export const createPostes = async (req, res) => {
